Projeto feito para treinar a utilização da lib react, falta implementar algumas funcionalidades ajeitar alguns estilos para junto aperfeiçoar minhas habilidades de CSS e como por exemplo a de acessar as configurações do usuário logado: 
